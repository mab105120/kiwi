...
_router: Dict[str, MenuFunctions] = {
    ...
    "1.4": MenuFunctions(executor=collector.get_transactions_by_user, printer=printer_utils.print_transactions_table),
    ...
    "3.6": MenuFunctions(executor=collector.get_transactions_by_portfolio_id, printer=printer_utils.print_transactions_table),
    ...
    "4.3": MenuFunctions(executor=collector.get_transactions_by_ticker, printer=printer_utils.print_transactions_table)
}
